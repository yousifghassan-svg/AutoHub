...
export default function PlatesPage() {
  ...
  const search = usePlateSearchInfinite(
    {
      keyword: q,
      prefix: submitted.code || undefined,
      series: submitted.letter || undefined,
      number: submitted.number || undefined,
      pageSize: 48,
      sortBy: 'createdAt',
      sortOrder: 'desc',
    },
  ...
  return (
    <div className="page-container space-y-10 py-10">
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Plates' }]} />
